...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            features::product::commands::get_product,
            features::product::commands::update_product,
            features::product::commands::polish_product,
            features::customers::commands::list_customers,
            features::customers::commands::create_customer,
            features::customers::commands::update_customer,
            features::customers::commands::delete_customer,
            ...
            features::prospects::commands::set_prospect_customer,
            features::prospects::commands::accept_stage_suggestion,
            features::prospects::commands::dismiss_stage_suggestion,
            features::prospects::commands::recheck_prospect_stage,
